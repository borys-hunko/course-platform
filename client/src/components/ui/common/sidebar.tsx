...
const HEADER_HEIGHT = '4rem'; //'calc(0.75rem + 0.75rem + 2.5rem)';
      ...
      return (
        ...
        >
          <SheetContent
            ...
            data-mobile='true'
            className='w-[--sidebar-width] bg-sidebar inset-y-[--header-height] h-[calc(100%-var(--header-height))]
          ...
          >
            ...
            <div className='flex h-full w-full flex-col p-3'>{children}</div>
          </SheetContent>
        </Sheet>
      );
    }
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity]',
